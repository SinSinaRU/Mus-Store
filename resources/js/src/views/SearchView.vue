    ...
    <div class="container ">
        ...
        <div class="raw">
            <div class="d-flex flex-wrap align-content-center justify-content-between ">
                <div class="elements_market col-12">
                    <div v-for="n in 5">
                    ...
                    <v-listing :max_page="Math.round(info.length / 5)" @current_page="getCurrentPage"/>
                </div>
            </div>
        </div>
    </div>
...
import vElementOfMarket from '@/components/v-element-of-market.vue'
