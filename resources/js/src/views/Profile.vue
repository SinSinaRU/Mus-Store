<template>
    <div class="container">
        ...
        <div class="row justify-content-between">
            ...
            <form @submit.prevent="changingUserData" class="col-8" v-else-if="edit_data" autocomplete="off">
                ...
                <div class="mb-3 row">
                    ...
                    <input class="col-5" type="text" id="first_name" name="first_name" size="18"
                ...
                <div class="mb-3 row">
                    ...
                    <input class="col-5" type="text" id="second_name" name="second_name" size="18"
        ...
        <v-element-of-orders v-for="order in orders_data" :price=order.order_price :status=order.status :number=order.id
...
export default {
    ...
    methods: {
        ...
        changingPassword() {
            let self = this;
            axios.post('/api' + window.location.pathname + '/change_password', this.passwords).then(function (response) {
                self.changePassword();
            });
        },
        changingUserData() {
